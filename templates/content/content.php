 ...
 *
 * Displays the content for a post in a singular view.
 */
	...
	<header class="entry-header <?php echo apply_filters( 'asc_entry_header_class', '' ); ?>">
		...
		<?php if ( $image ) : ?>
			<div class="entry-image <?php echo apply_filters( 'asc_entry_image_class', '' ); ?>">
				...
				<?php the_post_thumbnail( 'ascension-large', array( 'class' => 'the-entry-image ' . apply_filters( 'asc_single_image_class', '' ) ) ); ?>
